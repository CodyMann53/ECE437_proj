...
add wave -noupdate -group IF_ID_Register -expand -group IF_ID_Register /system_tb/DUT/CPU/DP/if_id_regif/instruction
...
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/opcode_IF_ID
...
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/Rs_IF_ID
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/Rt_IF_ID
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/Rd_IF_ID
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/func_IF_ID
...
add wave -noupdate -group IF_ID_Register -expand -group Outputs /system_tb/DUT/CPU/DP/if_id_regif/flush_IF_ID
...
add wave -noupdate -expand -group EX_MEM_Register -expand -group Outputs /system_tb/DUT/CPU/DP/ex_mem_regif/flush_EX_MEM
...
WaveRestoreCursors {{Cursor 1} {774261 ps} 0}
...
update
WaveRestoreZoom {603477 ps} {939919 ps}
