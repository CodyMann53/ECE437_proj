...
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/opcode_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/func_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/PCSrc_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/Rd_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/Rs_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/ALUSrc_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/Rt_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/WEN_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/alu_op_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/dREN_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/dWEN_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/datomic_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/enable_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/extend_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/flush_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/halt_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/iREN_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/imemaddr_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/imm16_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/imm16_ext_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/instruction_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/mem_to_reg_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/next_imemaddr_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/rdat1_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/rdat2_ID_EX
add wave -noupdate -expand -group {DataPath0 ID/EX Register} -group Outputs /system_tb/DUT/CPU/DP0/id_ex_regif/reg_dest_ID_EX
...
add wave -noupdate -expand -group {DataPath Cache Interface 0} /system_tb/DUT/CPU/dcif0/dmemload
...
add wave -noupdate -expand -group {Dcache0 Internal } -expand -subitemconfig {{/system_tb/DUT/CPU/CM0/DCACHE/cbl[4]} -expand} /system_tb/DUT/CPU/CM0/DCACHE/cbl
...
add wave -noupdate -expand -group {MUX 6 0} /system_tb/DUT/CPU/DP0/data_store
add wave -noupdate -expand -group {MUX 6 0} /system_tb/DUT/CPU/DP0/fu_reg_dest_EX_MEM
add wave -noupdate -expand -group {MUX 6 0} /system_tb/DUT/CPU/DP0/wdat
add wave -noupdate -expand -group {MUX 6 0} /system_tb/DUT/CPU/DP0/d_s
...
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/imemload
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/imemaddr
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/imemREN
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/ihit
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/halt
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/flushed
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dmemstore
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dmemload
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dmemaddr
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dmemWEN
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dmemREN
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/dcif1/dhit
add wave -noupdate -expand -group {DataPath Cache Interface 1} /system_tb/DUT/CPU/CM1/dcif/datomic
...
add wave -noupdate -expand -group {Dcache1 Internal} -expand -subitemconfig {{/system_tb/DUT/CPU/CM1/DCACHE/cbl[7]} {-height 17 -childformat {{{/system_tb/DUT/CPU/CM1/DCACHE/cbl[7].right_dat0} -radix hexadecimal}} -expand} {/system_tb/DUT/CPU/CM1/DCACHE/cbl[7].right_dat0} {-height 17 -radix hexadecimal}} /system_tb/DUT/CPU/CM1/DCACHE/cbl
...
WaveRestoreCursors {{Cursor 4} {3506950 ps} 0}
...
update
WaveRestoreZoom {3067154 ps} {4419154 ps}
