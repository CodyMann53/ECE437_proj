...
add wave -noupdate -group IF_ID_Register -expand -group IF_ID_Register -radix hexadecimal /system_tb/DUT/CPU/DP/if_id_regif/instruction
add wave -noupdate -group IF_ID_Register -expand -group IF_ID_Register /system_tb/DUT/CPU/DP/if_id_regif/imemaddr
add wave -noupdate -group IF_ID_Register -expand -group IF_ID_Register /system_tb/DUT/CPU/DP/if_id_regif/next_imemaddr
add wave -noupdate -group IF_ID_Register -expand -group IF_ID_Register /system_tb/DUT/CPU/DP/if_id_regif/flush_IF_ID
...
add wave -noupdate -group EX_MEM_Register -expand -group Outputs /system_tb/DUT/CPU/DP/ex_mem_regif/dmemaddr_EX_MEM
...
add wave -noupdate -group EX_MEM_Register -expand -group Outputs /system_tb/DUT/CPU/DP/ex_mem_regif/enable_EX_MEM
...
WaveRestoreCursors {{Cursor 4} {336603 ps} 1} {{Cursor 5} {335705 ps} 0}
...
update
WaveRestoreZoom {0 ps} {1344616 ps}
