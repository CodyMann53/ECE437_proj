...
add wave -noupdate -group ALU /system_tb/DUT/CPU/DP/aluif/result
add wave -noupdate -group ALU /system_tb/DUT/CPU/DP/aluif/alu_op
...
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/halt
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/ihit
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/imemREN
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/imemload
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/imemaddr
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dhit
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dmemREN
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dmemWEN
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dmemload
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dmemstore
add wave -noupdate -group {Data Path Ports} -radix hexadecimal /system_tb/DUT/CPU/DP/dpif/dmemaddr
...
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/ihit
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/imemaddr
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/jr_addr
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/next_imemaddr
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/jmp_addr
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/br_addr
add wave -noupdate -group {Program Counter} /system_tb/DUT/CPU/DP/pcif/PCSrc
...
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/halt
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/ihit
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/imemREN
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/imemload
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/imemaddr
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dhit
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dmemREN
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dmemWEN
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dmemload
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dmemstore
add wave -noupdate -group {Memory Controller } -radix hexadecimal /system_tb/DUT/CPU/CM/dcif/dmemaddr
...
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/result_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/dmemload
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/WEN_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/enable_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/flush_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/halt_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/reg_dest_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rt_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rd_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/WEN_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/halt
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/reg_dest_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/mem_data_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rt_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rd_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rs_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/mem_to_reg_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imemaddr_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/next_imemaddr_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/opcode_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/func_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/instruction_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imm16_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imm16_ext_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/dmemstore_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/rdat1_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/Rs_EX_MEM
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imemaddr_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/next_imemaddr_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/opcode_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/func_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/instruction_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imm16_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/imm16_ext_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/dmemstore_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/rdat1_MEM_WB
add wave -noupdate -expand -group MEM_WB_Register /system_tb/DUT/CPU/DP/mem_wb_regif/result_MEM_WB
